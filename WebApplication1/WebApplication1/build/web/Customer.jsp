                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        //        out.println("</form>");
                                                ...
                                                out.println("<td><button type=\"submit\" disabled=\"true\" class=\"btn btn-primary btn-xs\" id=\"s" + s.getId() + "\" method=\"POST\" action=\"reserveServlet\"><i class=\"fa fa-pencil\"></i> CONTACT STAFF </button></td></tr>");
                                                out.println("</tr>");
                                                out.println("</form>");
                                            }
                                    ...
                                    <tbody>
                                        <%    for (reservation s : ls) {
                                                ...
                                                if (s.getStatus().equalsIgnoreCase("PENDING PAYMENT")) {
                                                    ...
                                                    out.println("<input name='status' hidden readonly value='" + s.getStatus() + "'/>");
                                                    out.println("<input name='role' hidden readonly value='" + request.getAttribute("role") + "'/>");
                                                    out.println("<input name='rName' hidden readonly value='" + request.getAttribute("rName") + "'/>");
                                                    out.println("<input name='name' hidden readonly value='" + request.getAttribute("name") + "'/>");
                                                    out.println("<input hidden name='reservationID' readonly value='" + s.getId() + "'/>");

                                                    out.println("<input name='action' hidden readonly value='cancel'/>");
                                                    out.println("<input name='phone' hidden readonly value='" + s.getPhoneNo() + "'/>");
                                                    out.println("<td><button type=\"submit\"  class=\"btn btn-primary btn-xs\" id=\"s" + s.getId() + "\" method=\"POST\" ><i class=\"fa fa-pencil\"></i>CANCEL</button></td></tr>");
                                                } else if (s.getStatus().equalsIgnoreCase("CANCELLED")) {
                                                    out.println("<td><button disabled type=\"submit\"><i class=\"fa fa-pencil\"></i> CANCELLED </button></td>");

                                                    out.println("<td><button type=\"submit\" disabled class=\"btn btn-primary btn-xs\" id=\"s" + s.getId() + "\" method=\"POST\" action=\"reserveServlet\"><i class=\"fa fa-pencil\"></i>CANCELLED</button></td></tr>");
                                                } else {
                                                    out.println("<td><button disabled='true' readonly type=\"submit\"><i class=\"fa fa-pencil\"></i> PRINT RECEIPT ABOVE </button></td>");

                                                    out.println("<td><button type=\"submit\" disabled class=\"btn btn-primary btn-xs\" id=\"s" + s.getId() + "\" method=\"POST\" action=\"reserveServlet\"><i class=\"fa fa-pencil\"></i>CONTACT STAFF TO CANCEL </button></td></tr>");
                                                }
